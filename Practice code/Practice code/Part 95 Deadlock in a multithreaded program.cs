...
{
    class Part_95_Deadlock_in_a_multithreaded_program
    {
        //this code is to show the multi-threaded code can go in the deadlock.
    ...
    //uncomment this line to run this code.
